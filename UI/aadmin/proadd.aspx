<%@ Page Language="C#" MasterPageFile="~/aadmin/mu.master" AutoEventWireup="true" CodeFile="proadd.aspx.cs" Inherits="admin_product" Title="产品添加" %>
...
<div style="height:50px; font-size:18px; font-weight:bold; text-align:center; padding-top:10px;">商品添加</div>
