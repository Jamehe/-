<%@ Page Language="C#" MasterPageFile="~/aadmin/mu.master" AutoEventWireup="true" CodeFile="newsupdate.aspx.cs" Inherits="admin_newsupdate" Title="新闻更新" %>
...
<div>
   ...
   <div> &nbsp &nbsp <asp:Button ID="Button1" runat="server" Text="提交" onclick="Button1_Click" /> 
       <asp:Button ID="Button2" runat="server" Text="清空" onclick="Button2_Click" /> </div>
</div>   
</asp:Content>
