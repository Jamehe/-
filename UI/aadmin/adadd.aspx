<%@ Page Language="C#" MasterPageFile="~/aadmin/mu.master" AutoEventWireup="true" CodeFile="adadd.aspx.cs" Inherits="admin_flashadd" Title="flash添加" %>
...
<div  style=" font-size:16px; font-weight:bold; text-align:center; "> 广告添加</div>
