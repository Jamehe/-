<%@ Page Language="C#" MasterPageFile="~/aadmin/mu.master" AutoEventWireup="true" CodeFile="helplist.aspx.cs" Inherits="admin_helplist" Title="分类列表" %>
...
<div>
<div style="text-align:center; font-size:16px; font-weight:bold; margin-top:5px;">帮助信息列表</div>
<div style="padding-right:10px; text-align:right; margin-bottom:5px;">
    <asp:TextBox ID="txt_search" runat="server"></asp:TextBox>　<asp:Button ID="Button1"
...
<div style="margin-top:5px;">
    ...
    　<asp:Button ID="Button4" runat="server" Text="批量删除" onclick="Button4_Click" /></div>
