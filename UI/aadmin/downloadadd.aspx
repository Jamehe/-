<%@ Page Language="C#" MasterPageFile="~/aadmin/mu.master" AutoEventWireup="true" CodeFile="downloadadd.aspx.cs" Inherits="admin_downloadadd" Title="资源添加" %>
    ...
    <table class="style2">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
                                       <td class="style3">
                                           <asp:Label ID="size" runat="server" Text="Label" Visible="False"></asp:Label>
                                       </td>
                                       <td>
                                           &nbsp;</td>
                                   </tr>
