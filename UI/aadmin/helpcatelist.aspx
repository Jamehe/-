<%@ Page Language="C#" MasterPageFile="~/aadmin/mu.master" AutoEventWireup="true" CodeFile="helpcatelist.aspx.cs" Inherits="admin_alist" Title="帮助分类列表" %>
...
<div>
   <div style="  text-align:center; font-size:16px; font-weight:bold; margin-top:13px; "> 帮助分类表 </div>
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            DataKeyNames="_cateid" Width="100%" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="添加" ShowHeader="False">
                    ...
                    <ItemTemplate>
                       <a href='helpcateadd.aspx?uid=<%#Eval("_cateid")%>'>添加</a>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="更新" ShowHeader="False">      
                    <ItemTemplate>
                       <a href='helpcateupdate.aspx?uid=<%#Eval("_cateid")%>'>编辑</a>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
